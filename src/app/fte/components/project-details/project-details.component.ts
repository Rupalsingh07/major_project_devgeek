...
export class ProjectDetailsComponent implements OnInit {
  ...
  projectTasks:any=[]
  projects:any=[]
  projectName:any='DevGeek';
  projectDescription:any="Portal to handle innogeeks projects"
  projectStartDate:any='01-04-2022'
  projectEndDate:any='31-05-2022'
  owner:any='Pragya'
  con:any=[]
  users:any=[]
  userName:any
...
//end of component
createTask(){
  this.router.navigate(['leader/create-task']);
}
membersSubmit(){
  console.log("membrs added");
}
}
